...
//checks if image exists, and then returns ImageIcon object
        ...
        final ImageIcon icon9 = createImageIcon("reset22.png");
        label9 = new JLabel(icon9);
        label9.setVerticalAlignment(JLabel.TOP);
        label9.setHorizontalAlignment(JLabel.CENTER);
        label9.setOpaque(false);
        label9.setBounds(630, 50, 100 , 100);
        layeredPane.add(label9, new Integer(1));
...
//the images are represented as labels in the Jpanel
    ...
    class CustomMouseListener implements MouseListener {
        ...
        public void mouseClicked(MouseEvent e) {
            ...
            if(senderName.getName().equals("reset_button")){
    ...
    public  void cannibal_animation(String c) {
        ...
        {
            case "cannibal1":
//checking if boat on same side as cannibal
    ...
    public  void missionary_animation(String c) {
        ...
        switch (c)
        {
            ...
            case "missionary3":System.out.println("Right");
...
//if no of cannibals more than no of missionaries
    ...
    static public void reset(){
        ...
        label7.setBounds(1100, 430, 32, 59);
        label8.setBounds(1050, 430, 32, 59);
        boat_first_free=true;
        boat_second_free=true;
    }
